...
training_class = rml_training(learning_episode_office, RMLGym, states_for_encoding, actions, config_path, epsilon=0.2, gamma= 0.1, n=3)

results = training_class.get_test_statistics()

print(results)

with open('results/results_office_world_RML_num_encoding.pkl', 'wb') as f:
