...
from counter_machine.office_world.config import OfficeWorldCounterMachine
...
if __name__ == "__main__":
    ...
    N = 3
    number_of_repeats = 1
    results_file = "results/office_world_convergence_results_CF.pkl"
