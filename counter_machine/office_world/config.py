from counter_machine.machine import CounterMachine
...
class OfficeWorldCounterMachine(CounterMachine):
    def __init__(self):
        ...
        self.delta_u = {
            ...
            (("O",), 0, ("-","-")): 1,  # Transition to state 1 after collecting 'e'
            ...
            (("F",), 1, ("Z","-")): 2,  # Move to state 2 while collecting 'f' with zero counter
